...
public class BallistaTurretModel extends BaseTurretModel<BaseTurretRenderState> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		// Base
		PartDefinition base = modelPartData.addOrReplaceChild("base", CubeListBuilder.create().texOffs(56, 46).addBox(-8.0F, -1.0F, -1.0F, 7.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
