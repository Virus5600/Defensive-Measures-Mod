...
public class MGTurretModel extends BaseTurretModel<BaseTurretRenderState> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		// Right Stand
		PartDefinition right_stand = body.addOrReplaceChild("right_stand", CubeListBuilder.create(), PartPose.offset(-2.5F, -1.3F, 0.25F));
		// Right Stand 1
		right_stand.addOrReplaceChild("right_stand_r1", CubeListBuilder.create().texOffs(12, 51).addBox(-0.5F, 0.0F, 1.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
			...
			.texOffs(48, 0).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.45F, 2.0F, -0.5236F, 0.0F, 0.0F));

		// Left Stand
		PartDefinition left_stand = body.addOrReplaceChild("left_stand", CubeListBuilder.create(), PartPose.offset(2.5F, -1.3F, 0.25F));
		// Left Stand 1
		left_stand.addOrReplaceChild("left_stand_r1", CubeListBuilder.create().texOffs(52, 0).addBox(-0.5F, 0.0F, 1.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
			...
			.texOffs(48, 24).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.45F, 2.0F, -0.5236F, 0.0F, 0.0F));

		// Head
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, -5.5F, 2.25F));

		// Gun
		PartDefinition gun = head.addOrReplaceChild("gun", CubeListBuilder.create().texOffs(0, 36).addBox(-1.8F, -1.45F, 0.9484F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
			.texOffs(8, 47).addBox(-1.3F, -1.2F, -0.0516F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
			.texOffs(34, 46).addBox(-0.8F, -0.95F, -4.0516F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
			.texOffs(48, 8).addBox(-0.3F, -0.7F, -6.0516F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.2F, -0.3F, -4.1984F));

		// Discarded Ammo
		gun.addOrReplaceChild("discarded_ammo", CubeListBuilder.create().texOffs(48, 32).addBox(-0.5F, -0.5F, -0.675F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.33F)), PartPose.offset(-1.3F, -0.7F, 1.6234F));
		...
		gun.addOrReplaceChild("ejection_port", CubeListBuilder.create().texOffs(27, 41).addBox(-0.5375F, -0.725F, -0.7F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.44F))
			...
			.texOffs(31, 47).addBox(-0.5125F, -0.4F, -1.3F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.44F)), PartPose.offset(-1.7625F, -0.7F, 2.0F));
		...
		gun.addOrReplaceChild("ammo_case", CubeListBuilder.create().texOffs(46, 46).addBox(1.6502F, -0.5006F, -1.9165F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
			.texOffs(22, 46).addBox(-0.3498F, -1.5006F, -1.9165F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(3.5498F, 0.3006F, 3.8649F));

		// Rounds
		PartDefinition rounds = gun.addOrReplaceChild("rounds", CubeListBuilder.create(), PartPose.offset(1.425F, -1.45F, 3.6984F));
		// Ammo 1
