package com.virus5600.defensive_measures.model.entity.tier2;
...
import com.virus5600.defensive_measures.animations.entity.tier2.MissileTurretAnimation;
...
public class MissileTurretModel extends BaseTurretModel<MissileTurretRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = partDefinition.addOrReplaceChild("base", CubeListBuilder.create().texOffs(104, 68).addBox(-16.0F, -2.0F, -10.0F, 4.0F, 2.0F, 20.0F, new CubeDeformation(0.0F))
