...
public class FlakCloudParticle extends SingleQuadParticle {
	// CONSTRUCTORS //
	public FlakCloudParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet, double xd, double yd, double zd) {
		...
		this.quadSize = 0.1F * (this.random.nextFloat() * this.random.nextFloat() * 15.0F + 10.0F);
