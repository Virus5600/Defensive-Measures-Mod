package com.virus5600.defensive_measures.item.turrets.flame_turret;
...
/**
 * The item that spawns the {@link FlameTurretEntity Flame Turret}.
 *
 * @since 1.1.0-beta
 * @author <a href="https://github.com/Virus5600">Virus5600</a>
 */
public class FlameTurretItem extends TurretItem {
	public FlameTurretItem(EntityType<? extends Mob> type, Properties settings) {
		super(
			type,
			settings
				.stacksTo(16)
	...
	public void appendHoverText(ItemStack stack, @NonNull TooltipContext context, @NonNull TooltipDisplay displayComponent, @NonNull Consumer<Component> textConsumer, @NonNull TooltipFlag type) {
		...
		for (int i = 1; i <= 3; i++) {
			textConsumer.accept(
				Component.translatable("itemTooltip.dm.flame_turret.line" + i)
	...
	public float getTurretMaxHealth() {
		...
		if (superClass instanceof TurretEntity) {
			maxHealth = ((FlameTurretEntity) superClass).getMaxHealth();
		}
